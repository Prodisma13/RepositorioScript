...
#Quinta Versión de programa para git
#Esta quinta versión te permite elegir que hacer a la hora de usar git
...
case $seleccion in 
	...
	8)
		...
		cp $script $ruta
		echo "" #Linea de espacio
		echo "Tu script se ha copiado correctamente"
	;;
	...
	9)
		...
		rm -r $script
		echo "" #Linea de espacio
		echo "Tu script se ha eliminado correctamente"
	;;
