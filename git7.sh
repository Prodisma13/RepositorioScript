...
echo "" #Linea de espacio
echo "9. Entrar en una rama"
echo "" #Linea de espacio
echo "Opciones extras"
echo "-----------------------------------------------------"
echo "" #Linea de espacio
echo "10. Mover script al directorio deseado (Copia)"
echo "" #Linea de espacio
echo "11. Eliminar script del directorio actual"


echo "" #Linea de espacio

#Selección de opción
read -p "Elige que quieres hacer(1-11): " seleccion
...
case $seleccion in 
	...
	8)
		echo "Crear una nueva rama"
		echo "" #Linea de espacio
		read -p "Escribe el nombre de tu nueva rama: " rama
		echo "" #Linea de espacio
		git branch $rama
		echo "Tu rama se ha creado correctamente"

	;;

	9)
		echo "Entrar en una rama"
		echo "" #Linea de espacio
		read -p "Escribe el nombre de la rama a la que quieres entrar:" rama
		echo "" #Linea de espacio
		git checkout $rama
